...
module.exports.views = {
    ...
    engine: {
        ext: 'handlebars',
        fn: require('sails/node_modules/express-handlebars/node_modules/handlebars').__express
    },
    ...
    helpers: [
        require('../assets/scripts/templates/helpers/conditions'),
        require('../assets/scripts/templates/helpers/date'),
        require('../assets/scripts/templates/helpers/eachlist'),
        require('../assets/scripts/templates/helpers/string')
    ]
